        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimePerMoveSec = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Player_Id", "[Id] BETWEEN 1 AND 1000");
                    table.CheckConstraint("CK_Player_Phone", "LEN([Phone]) = 10 AND [Phone] NOT LIKE '%[^0-9]%'");
                    table.ForeignKey(
